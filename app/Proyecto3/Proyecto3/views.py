...
path_media = r'C:\Users\Humberto Morales\OneDrive\Escritorio\Rodrigo\app\Proyecto3'
...
def docu(request):
    try:
        return FileResponse(open('C:/Users/Humberto Morales/OneDrive/Escritorio/Rodrigo/Documentacion/EnsayoIPC2.pdf', 'rb'), content_type='application/pdf')
